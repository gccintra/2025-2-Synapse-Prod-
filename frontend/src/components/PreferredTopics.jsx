          ...
          <AnimatePresence>
            {topics.map((topic) => (
              <motion.div
                ...
                className="flex items-center gap-2 bg-white text-gray-900 text-sm font-medium border border-black shadow-lg pl-3 pr-2 py-1 rounded-full font-montserrat cursor-pointer"
              >
